...
les locaux sont situés à proximité du Palais de Justice de Narbonne. Les rendez-vous sont pris par téléphone ou par courrier électronique.        </Typography>
        ...
        <Grid container spacing={1} sx={{mt:0, mr:1}}>
                ...
                <Grid item xs={12} md={6} lg={3} align="center">
                  <DomaineCard  style={{textAlign:"center"}} domaine="" title="Réactivité" detail={["Disponible pour vous assister dans les situations d’urgence."]}/>
                </Grid>
                <Grid item xs={12} md={6}  lg={3} align="center">
                  <DomaineCard style={{textAlign:"center"}}  domaine=""  title="Proximité" detail={["Situé à 2 minutes du Tribunal et du commissariat."]}/>
                </Grid>
                <Grid item xs={12} md={6}  lg={3} align="center">
                  <DomaineCard style={{textAlign:"center"}}  domaine=""  title="Mobilité" detail={["Déplacement sur tout le territoire national."]}/>
                </Grid>
                <Grid item xs={12} md={6}  lg={3} align="center">
                  <DomaineCard style={{textAlign:"center"}}   domaine=""  title="Transparence" detail={["Etablissement d’une convention d’honoraires claire et détaillée"]}/>
                </Grid>
            </Grid>
